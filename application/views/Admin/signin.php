...
<body class="h-14 bg-linear-to-r from-[#E7A2B8] to-[#FF77A2]">
    <div>
        ...
        <div class="px-[5%] py-[3%] bg-[#FBF6F6] mx-[5%] my-[5%]">
            <div class="flex flex-col items-center text-3xl text-[#B66878] aladin-regular w-[100%] mb-1 text-center">
                SignIn
                <img src="<?= base_url('Assets/Google.png') ?>" alt="Google" class="text-[#B66878] h-10 w-auto mt-4">
            </div>
                ...
                <form action="" method="post" class="alike-regular">
                    <div class="grid gap-2 mb-6">
                        ...
                        <div class="text-center mb-3">
                            <button type="submit"
                                class="text-white bg-[#FF77A2] hover:bg-[#B66878] font-medium rounded-3xl text-2xl aladin-regular w-full sm:w-[20%] px-5 py-2.5">SignIn</button>
                        </div>
                        <div class="text-center">
                            <label for="remember" class="ms-2 text-base font-medium alike-regular text-[#FF77A2]">Don't
                                have an account yet?
                                <a href="<?php echo base_url('signup'); ?>"
                                    class="text-xl text-[#FF77A2] hover:underline aladin-regular">SignUp</a></label>
                        </div>
                    </div>
                </form>
            </div>
